...
from TDA_Lista import T_Lista, insertar, busqueda, eliminar
...
class tda_hash():
    ...
    def __init__(self):
        ...
        for i in range(20, 99):
            self.dos.append(T_Lista())

        for i in range(36, 88):
            self.tres.append(T_Lista())
        
        for i in range(202, 983):
            self.dosb.append(T_Lista())
        
        for i in range(327, 894):
            self.tresb.append(T_Lista())
